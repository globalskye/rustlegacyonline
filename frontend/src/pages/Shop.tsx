      ...
      >
        ...
        <div className="card" style={{
          ...
          <p style={{
            ...
            Our shop is currently under construction. Soon you'll be able to purchase VIP status, 
            cosmetic items, and other exclusive content to enhance your gameplay experience.
          </p>
        </div>
      </motion.div>
    </div>
